...
{return cljs.core.map.call(null,(function (p1__7661_SHARP_){return {"text": [cljs.core.str(new cljs.core.Keyword(null,"command","command",1964298941).cljs$core$IFn$_invoke$arity$1(p1__7661_SHARP_))].join(''), "completion": [cljs.core.str(new cljs.core.Keyword(null,"command","command",1964298941).cljs$core$IFn$_invoke$arity$1(p1__7661_SHARP_))].join('')};
...
{return cljs.core.map.call(null,(function (p1__7662_SHARP_){if(cljs.core.not.call(null,new cljs.core.Keyword(null,"desc","desc",1016984067).cljs$core$IFn$_invoke$arity$1(p1__7662_SHARP_)))
{return {"text": [cljs.core.str(new cljs.core.Keyword(null,"command","command",1964298941).cljs$core$IFn$_invoke$arity$1(p1__7662_SHARP_))].join(''), "completion": [cljs.core.str(new cljs.core.Keyword(null,"command","command",1964298941).cljs$core$IFn$_invoke$arity$1(p1__7662_SHARP_))].join('')};
} else
{return {"text": new cljs.core.Keyword(null,"desc","desc",1016984067).cljs$core$IFn$_invoke$arity$1(p1__7662_SHARP_), "completion": [cljs.core.str(new cljs.core.Keyword(null,"command","command",1964298941).cljs$core$IFn$_invoke$arity$1(p1__7662_SHARP_))].join('')};
}
}),cljs.core.vals.call(null,new cljs.core.Keyword(null,"commands","commands",4706336250).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.command.manager))));
}
});
...
exec_BANG_.cljs$lang$applyTo = (function (arglist__7663){
var cmd = cljs.core.first(arglist__7663);
var args = cljs.core.rest(arglist__7663);
