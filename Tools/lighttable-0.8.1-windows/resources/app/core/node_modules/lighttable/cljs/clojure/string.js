...
{{
var G__15742 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15742;
continue;
}
} else
...
{var pred__15746 = cljs.core._EQ_;var expr__15747 = limit;if(cljs.core.truth_(pred__15746.call(null,1,expr__15747)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15746.call(null,2,expr__15747)))
...
var G__15749 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15750 = (limit__$1 - 1);
var G__15751 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15749;
limit__$1 = G__15750;
parts = G__15751;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___15753 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___15753))
{var replacement_15754 = temp__4090__auto___15753;buffer.append([cljs.core.str(replacement_15754)].join(''));
} else
{buffer.append(ch);
}
{
var G__15755 = (index + 1);
index = G__15755;
continue;
}
}
